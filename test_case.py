...
def RDT_start_test(sender_sock, reciever_sock, sender_address, receiver_address, test_case):
    sender = threading.Thread(target=RDT_send, args=(sender_sock, sender_address, receiver_address, test_case))
    receiver = threading.Thread(target=RDT_receive, args=(reciever_sock, receiver_address, test_case))
...
def RDT_receive(reciever_sock: RDTSocket, source_address, test_case):
    ...
    server_receiver = threading.Thread(target=server_sock.recv)
    server_receiver.start()
    # print(server_sock.address)
